...
(function($) {
  ...
  $.fn.raty.defaults = {
    ...
    single       : false,
    space        : true,
    starHalf     : 'splat-half.png',
    starOff      : 'splat-off.png',
    starOn       : 'splat-on.png',
    starType     : 'img',
    target       : undefined,
    targetFormat : '{score}',
...
function initStars(){
  $(".star").each(function() {
    ...
    $(this).raty({
      ...
      starOn:      $(this).attr('data-splat-on'),
      starOff:     $(this).attr('data-splat-off'),
      starHalf:    $(this).attr('data-splat-half'),
      ...
      click: function(score, evt) {
        if ($(evt.target).data('readonly') === 'true') {
          return;
        }
